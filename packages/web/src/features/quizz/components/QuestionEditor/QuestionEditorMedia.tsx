    ...
    <div className="relative z-10 flex flex-1 flex-col items-center justify-center gap-3 p-4">
      ...
      {!questionMedia?.type && (
        <Card className="my-auto flex max-h-100 w-full max-w-xl flex-1 flex-col items-center justify-center gap-2">
          <ImageOff className="stroke-text-muted size-16" />
          ...
          <div className="flex flex-wrap justify-center gap-2">
            <Button
              ...
              className="bg-panel border-border text-text-body hover:bg-brand-tint border"
            >
      ...
      {questionMedia?.type && (
        <div className="absolute bottom-4">
          <Button
            className="bg-danger-tint border-danger-border text-danger rounded-rz-sm border px-4 py-2 font-semibold"
